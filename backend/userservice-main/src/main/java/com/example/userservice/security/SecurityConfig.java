...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/login/**","/api/user/infos/**", "/api/token/refresh/**" , "/api/user/save/**" , "/api/confirm-account" , "/api/verify/**" , "/api/verifyjs/**"
        , "/api/getName/**").permitAll();
...
//        http.authorizeRequests().antMatchers(POST, "/api/user/save/**").hasAnyAuthority("ROLE_ADMIN","ROLE_USER");
